...
<div class="container mt-5">
	<form class="rounded p-3 mt-5 text-center w-75 ml-auto mr-auto text-dark bg-light" id="intakeForm">
			<div class="form-group mt-2">
				...
				<input type="text" class="form-control w-50 ml-auto mr-auto" id='fName' name="fName" placeholder="First name">
				<small id='firstSub' class="text-danger">Please enter a Valid First Name</small>
			</div>
		<div class="form-group mt-2">
			<label for="lName">Last Name</label>
			<input type="text" class="form-control w-50 ml-auto mr-auto" id='lName' name="lName" placeholder="Last name">
			<small id='lastSub' class="text-danger">Please enter a Valid Last Name</small>
		</div>
		<div class="form-group mt-2">

			<label for="email">Email address</label>
			<input type="text" class="form-control w-50 ml-auto mr-auto" id="email" aria-describedby="emailHelp" placeholder="Enter email">
			<small id='emailSub' class="text-danger ">Please enter a Valid Email Address</small>
		</div>
		<div class="form-group mt-2">
			<label for="dob">Date of Birth</label>
			<input type="date" class="form-control w-50 ml-auto mr-auto" id="dob">
			...
			$.ajax(
				{
					...
					success: function (data) {
						if (data.error) {
							...
							console.log(data);
							window.location.replace('<?php echo base_url();?>users?create=true');
						}
					}
				});
		}
